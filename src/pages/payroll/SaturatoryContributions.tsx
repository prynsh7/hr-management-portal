...
const SaturatoryContributions = (props: Props) => {
  ...
  const breadcrumbItems = ["Payroll", "Satutory Contributions"];
  return (
    <div>
      <PayrollModal
        isOpen={isOpen}
      ...
      />
      <Header
        heading="Satutory Contributions"
...
export default SaturatoryContributions